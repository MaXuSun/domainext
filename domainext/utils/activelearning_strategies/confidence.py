...
def leastconfidence(**kwargs):
    return LeastConfidence(**kwargs)

@STRATEGY_REGISTRY.register()
def leastconfidence_dropout(**kwargs):
    return LeastConfidenceDropout(**kwargs)
