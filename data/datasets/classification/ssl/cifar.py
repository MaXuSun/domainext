...
from utils.common.tools import listdir_nohidden

from utils.common.build import DATASET_REGISTRY
from data.datasets.base_dataset import ClassDatasetBase,LabelDatum


@DATASET_REGISTRY.register()
class CIFAR10(ClassDatasetBase):
    """CIFAR10 for SSL.
    ...
    def _read_data_train(self, data_dir, num_labeled, val_percent):
        ...
        for label, class_name in enumerate(class_names):
            ...
            for i, imname in enumerate(imnames_train):
                ...
                item = LabelDatum(impath=impath, label=label)
