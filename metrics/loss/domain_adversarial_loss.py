"""
Imported from: https://github.com/thuml/Transfer-Learning-Library/dalib/adaptation/adda.py
...
from models.classification.network.grl import WarmStartGradientReverseLayer
...
class DomainAdversarialLossADDA(nn.Module):
    ...
    def __init__(self):
        super(DomainAdversarialLossADDA, self).__init__()
...
class DomainAdversarialLossDANN(nn.Module):
    r"""
    ...
    def __init__(self, domain_discriminator: nn.Module, reduction: Optional[str] = 'mean', grl: Optional[nn.Module] = None):
        super(DomainAdversarialLossDANN, self).__init__()
